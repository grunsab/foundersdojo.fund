...
export const metadata: Metadata = {
  title: "Locations",
  description:
    "The current Founder's Dojo FU ND footprint across San Francisco, Lake Tahoe, and Las Vegas, with San Francisco as the base for residency batches every two months beginning June 1, 2026."
};
